...
# Range from May 9, 2023 to October 13, 2024
...
print(f"[*] Starting backfill for range {start_date.strftime('%Y-%m-%d')} to {end_date.strftime('%Y-%m-%d')} ({total_days} days)...")
...
print(f"[+] Finished generating {total_commits} commits across {total_days} days! Syncing to GitHub...")
